...
template <> constexpr inline auto ChatServer::qt_create_metaobjectdata<qt_meta_tag_ZN10ChatServerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'startServer'
        QtMocHelpers::SlotData<void(quint16)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::UShort, 5 },
        }}),
        // Slot 'startServer'
        ...
        // Slot 'readClientData'
        QtMocHelpers::SlotData<void(QTcpSocket *)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 8, 9 },
        }}),
        // Slot 'broadcastMsg'
        QtMocHelpers::SlotData<void(QByteArray, QTcpSocket *)>(10, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QByteArray, 11 }, { 0x80000000 | 8, 12 },
        }}),
    };
...
void ChatServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sendLogMsg((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->startServer((*reinterpret_cast< std::add_pointer_t<quint16>>(_a[1]))); break;
        case 2: _t->startServer(); break;
        case 3: _t->stopServer(); break;
        case 4: _t->readClientData((*reinterpret_cast< std::add_pointer_t<QTcpSocket*>>(_a[1]))); break;
        case 5: _t->broadcastMsg((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QTcpSocket*>>(_a[2]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ChatServer::*)(QString )>(_a, &ChatServer::sendLogMsg, 0))
            return;
    }
}
...
// SIGNAL 0
void ChatServer::sendLogMsg(QString _t1)
{
